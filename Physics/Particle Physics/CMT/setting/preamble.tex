...
% LAW BOX
%================================
\newtcbtheorem[number within=chapter]{law}{Law}{
  title={#2},
  breakable,
  enhanced,
  colframe=tiffanyblue!15,
  colback=tiffanyblue!10
  coltitle=black!5!white,
  fonttitle = \bfseries,
  description font = \mdseries,
  title style={left color=tiffanyblue!70!white, right color=tiffanyblue!15, rounded corners},
...
\newcommand{\lw}[2]{\begin{law}{#1}{ }#2\end{law}}
...
{\addvspace{30pt}%
  \begin{tikzpicture}[remember picture, overlay]%
    \draw[fill=doc!60,draw=doc!60] (-7,-0.1) rectangle (-0.2,0.52);%
    \pgftext[left,x=-3cm,y=0.2cm]{\color{white}\Large\scshape\bfseries Chapter\ \thecontentslabel};%
